...
export type WordOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"text", ExtArgs["result"]["word"]>
...
export interface WordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Words and only return the `text`
   * const wordWithTextOnly = await prisma.word.createManyAndReturn({
   *   select: { text: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Words and only return the `text`
   * const wordWithTextOnly = await prisma.word.updateManyAndReturn({
   *   select: { text: true },
   *   where: {
   *     // ... provide filter here
   *   },
